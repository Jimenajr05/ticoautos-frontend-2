...
function VehicleCard({ vehicle }) {
  ...
  // GraphQL puede devolver user como ID, REST puede devolver user como objeto
  const ownerName =
    typeof vehicle.user === "object" && vehicle.user !== null
      ? `${vehicle.user.name || ""} ${vehicle.user.lastName || ""}`.trim()
